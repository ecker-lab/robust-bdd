...
pip3 install matplotlib==3.2.2 tqdm Pillow shapely==1.7.0 opencv-python==4.2.0.34 pandas==1.0.5 scikit-learn==0.23.1 imgaug==0.4.0 imantics==0.1.12 scipy==1.5.0 scikit-image==0.17.2
